      ...
      <div className="section about-welcome" style={{ backgroundColor: 'var(--color-primary)' }}>
        <div className="container">
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '60px', alignItems: 'center' }}>
            ...
            <div className="about-image" style={{ borderRadius: '16px', overflow: 'hidden', boxShadow: 'var(--shadow-md)', height: '500px', display: 'flex', justifyContent: 'center', alignItems: 'center', backgroundColor: '#000' }}>
              <iframe 
                ...
                width="314" 
                height="560" 
                style={{ border: 'none', overflow: 'hidden', transform: 'scale(0.9)' }} 
                scrolling="no" 
                frameBorder="0" 
